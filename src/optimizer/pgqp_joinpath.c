...
void
#ifdef __PG_QUERY_PLAN__
pgqp_add_paths_to_joinrel(PlannerInfo *root,
						  RelOptInfo *joinrel,
						  RelOptInfo *outerrel,
						  RelOptInfo *innerrel,
						  JoinType jointype,
...
#ifdef __PG_QUERY_PLAN__
		pgqp_compute_semi_anti_join_factors(root, joinrel, outerrel, innerrel,
				  ...
				  JoinPathExtraData *extra)
{
	 ...
	 */
#ifdef __PG_QUERY_PLAN__
	pgqp_initial_cost_nestloop(root, &workspace, jointype,
						  ...
						  pathkeys, required_outer))
	{
		...
		add_path(joinrel, (Path *)
				 pgqp_create_nestloop_path(root,
										   joinrel,
										   jointype,
										   &workspace,
										   extra,
				   ...
				   bool is_partial)
{
	 ...
	 */
#ifdef __PG_QUERY_PLAN__
	pgqp_initial_cost_mergejoin(root, &workspace, jointype, mergeclauses,
...
#ifdef __PG_QUERY_PLAN__
		add_path(joinrel, (Path *)
				 pgqp_create_mergejoin_path(root,
											joinrel,
											jointype,
											&workspace,
											extra,
				  ...
				  JoinPathExtraData *extra)
{
	 ...
	 */
#ifdef __PG_QUERY_PLAN__
	pgqp_initial_cost_hashjoin(root, &workspace, jointype, hashclauses,
...
#ifdef __PG_QUERY_PLAN__
		add_path(joinrel, (Path *)
				 pgqp_create_hashjoin_path(root,
										   joinrel,
										   jointype,
										   &workspace,
										   extra,
