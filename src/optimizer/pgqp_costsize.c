...
void
#ifdef __PG_QUERY_PLAN__
pgqp_cost_index(IndexPath *path, PlannerInfo *root, double loop_count,
				bool partial_path)
#else
...
void
#ifdef __PG_QUERY_PLAN__
pgqp_cost_bitmap_heap_scan(Path *path, PlannerInfo *root, RelOptInfo *baserel,
						   ParamPathInfo *param_info,
...
void
#ifdef __PG_QUERY_PLAN__
pgqp_cost_bitmap_tree_node(Path *path, Cost *cost, Selectivity *selec)
#else
...
void
#ifdef __PG_QUERY_PLAN__
pgqp_cost_bitmap_and_node(BitmapAndPath *path, PlannerInfo *root)
#else
...
void
#ifdef __PG_QUERY_PLAN__
pgqp_cost_tidrangescan(Path *path, PlannerInfo *root,
...
void
#ifdef __PG_QUERY_PLAN__
pgqp_cost_group(Path *path, PlannerInfo *root,
				int numGroupCols, double numGroups,
				List *quals,
				Cost input_startup_cost, Cost input_total_cost,
				double input_tuples)
...
void
#ifdef __PG_QUERY_PLAN__
pgqp_initial_cost_nestloop(PlannerInfo *root, JoinCostWorkspace *workspace,
						   JoinType jointype,
...
void
#ifdef __PG_QUERY_PLAN__
pgqp_final_cost_nestloop(PlannerInfo *root, NestPath *path,
...
void
#ifdef __PG_QUERY_PLAN__
pgqp_initial_cost_mergejoin(PlannerInfo *root, JoinCostWorkspace *workspace,
							JoinType jointype,
							List *mergeclauses,
							Path *outer_path, Path *inner_path,
...
void
#ifdef __PG_QUERY_PLAN__
pgqp_final_cost_mergejoin(PlannerInfo *root, MergePath *path,
						  JoinCostWorkspace *workspace,
						  JoinPathExtraData *extra)
#else
...
void
#ifdef __PG_QUERY_PLAN__
pgqp_initial_cost_hashjoin(PlannerInfo *root, JoinCostWorkspace *workspace,
						   JoinType jointype,
						   List *hashclauses,
						   Path *outer_path, Path *inner_path,
						   JoinPathExtraData *extra,
...
void
#ifdef __PG_QUERY_PLAN__
pgqp_final_cost_hashjoin(PlannerInfo *root, HashPath *path,
						 JoinCostWorkspace *workspace,
						 JoinPathExtraData *extra)
#else
...
void
#ifdef __PG_QUERY_PLAN__
pgqp_compute_semi_anti_join_factors(PlannerInfo *root,
									RelOptInfo *joinrel,
									RelOptInfo *outerrel,
									RelOptInfo *innerrel,
									JoinType jointype,
...
void
#ifdef __PG_QUERY_PLAN__
pgqp_set_baserel_size_estimates(PlannerInfo *root, RelOptInfo *rel)
#else
...
double
#ifdef __PG_QUERY_PLAN__
pgqp_get_parameterized_baserel_size(PlannerInfo *root, RelOptInfo *rel,
									List *param_clauses)
#else
...
void
#ifdef __PG_QUERY_PLAN__
pgqp_set_joinrel_size_estimates(PlannerInfo *root, RelOptInfo *rel,
								RelOptInfo *outer_rel,
								RelOptInfo *inner_rel,
								SpecialJoinInfo *sjinfo,
								List *restrictlist)
...
double
#ifdef __PG_QUERY_PLAN__
pgqp_get_parameterized_joinrel_size(PlannerInfo *root, RelOptInfo *rel,
									Path *outer_path,
									Path *inner_path,
									SpecialJoinInfo *sjinfo,
...
void
#ifdef __PG_QUERY_PLAN__
pgqp_set_result_size_estimates(PlannerInfo *root, RelOptInfo *rel)
#else
